...
exports.handleIncomingWhisper = handleIncomingWhisper;
exports.handleSystemMessage = handleSystemMessage;
exports.handleBotDisconnect = handleBotDisconnect;
exports.getSession = getSession;
exports.addSSEClient = addSSEClient;
exports.removeSSEClient = removeSSEClient;
const tradeSessions = new Map(); // sessionId -> session
const pendingWhispers = new Map(); // sellerName.toLowerCase() -> sessionId
const sseClients = new Map(); // sessionId -> Set<res>
const buyerCooldowns = new Map(); // buyerUsername.toLowerCase() -> timestamp
// Dependencies (injected via init)
let sendWhisperFn = null;
let ioRef = null;
let getBotUsernameFn = null;
// Constants
...
function handleIncomingWhisper(senderName, message) {
...
function handleSystemMessage(messageRaw) {
    if (!messageRaw)
        return;
    ...
    if (session.currentWhisperTarget.toLowerCase() !== nameKey)
        return;
...
//# sourceMappingURL=trade-sessions.js.map