...
exports.FALLBACK_WORDS = exports.FALLBACK_RIDDLES = exports.FALLBACK_TRIVIA = exports.ShuffleDeck = void 0;
exports.generateTrivia = generateTrivia;
exports.generateRiddle = generateRiddle;
exports.generateHangman = generateHangman;
exports.generateScramble = generateScramble;
exports.generateNumberGuess = generateNumberGuess;
exports.scrambleWord = scrambleWord;
exports.buildRevealedWord = buildRevealedWord;
exports.sanitizeName = sanitizeName;
exports.resetCustomDecks = resetCustomDecks;
// -- Shuffle Deck (no-repeat cycling) --
class ShuffleDeck {
    _get;
    _deck;
    constructor(sourceArrayGetter) {
...
const deckFallbackTrivia = new ShuffleDeck(() => exports.FALLBACK_TRIVIA);
const deckFallbackRiddles = new ShuffleDeck(() => exports.FALLBACK_RIDDLES);
const deckFallbackWords = new ShuffleDeck(() => exports.FALLBACK_WORDS);
const deckCustomTrivia = new ShuffleDeck(() => state_1.default.customTrivia);
const deckCustomRiddles = new ShuffleDeck(() => state_1.default.customRiddles);
const deckCustomWords = new ShuffleDeck(() => state_1.default.customWords);
// -- Generators --
function generateTrivia(charLimit, callback) {
    let q = null;
    if (state_1.default.customTrivia.length > 0) {
        q = deckCustomTrivia.draw();
    }
    if (!q) {
        q = deckFallbackTrivia.draw() || exports.FALLBACK_TRIVIA[0];
    }
...
function generateRiddle(charLimit, callback) {
    let r = null;
    if (state_1.default.customRiddles.length > 0) {
    ...
    if (r) {
        ...
        r = deckFallbackRiddles.draw() || exports.FALLBACK_RIDDLES[0];
        callback(null, { question: r.riddle, answer: r.answer, hint: r.hint });
    }
}
function generateHangman(callback) {
    let w = null;
    if (state_1.default.customWords.length > 0) {
        w = deckCustomWords.draw();
    }
    if (!w) {
        w = deckFallbackWords.draw() || exports.FALLBACK_WORDS[0];
    }
