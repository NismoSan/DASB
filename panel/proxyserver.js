...
(() => {
  ...
  (function() {
    ...
    document.getElementById("btn-mon-sp-save").addEventListener("click", function() {
      ...
      if (evoName) {
        sp.evolution = { name: evoName, sprite: parseInt(document.getElementById("mon-sp-evo-sprite").value) || 0, level: parseInt(document.getElementById("mon-sp-evo-level").value) || 16 };
      }
